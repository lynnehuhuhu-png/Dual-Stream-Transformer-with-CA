...
from models.TST_adapted import TST_DualStream
...
def main():
    ...
    for epoch in range(100):
        ...
        if val_r2 > best_val_r2:
            ...
            torch.save(model.state_dict(), "results/best_TST.pth")
        else:
            patience_counter += 1
    ...
    model.load_state_dict(torch.load('results/best_TST.pth'))
    ...
    import json
    with open("results/TST_results.json", "w") as f:
        json.dump({
            "model": "TST",
    ...
    print("✅ 结果已保存至: results/TST_results.json")
